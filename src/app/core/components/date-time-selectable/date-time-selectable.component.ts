import { Component, ComponentRef, forwardRef, OnDestroy, OnInit, ViewContainerRef } from '@angular/core';
...
import { CustomerSelectableComponent } from '../person-selectable/person-selectable.component';
